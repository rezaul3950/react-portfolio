...
const Hero = () => {
  ...
  return (
    <section className="hero" id="home">
      ...
      {/* ১. টপ কোডিং স্ট্যাটাস */}
      <motion.div 
        className="hero-top-status"
        ...
        >
          <div className="hero-text-content">
            ...
            <motion.h1 variants={itemVariants} className="hero-title">
              Frontend <span className="v12-highlight">Developer</span> <br />
            <span className="typing-wrapper">
             <span className="static-r">R</span>
               ...
               sequence={[
                  "eact Enthusiast",
                    ...
                    speed={50}
                     deletionSpeed={40}
                     repeat={Infinity}
                    cursor={false} // ❗ default cursor off
                     className="typing-text"
                   />

            <span className="custom-cursor">I</span>
            </span>
            </motion.h1>
          ...
          <motion.div className="hero-social-wrapper" variants={itemVariants}>
            ...
            <div className="social-links">
              <a href="https://github.com/rezaul3950" target="_blank" rel="noreferrer" className="social-btn github">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg>
              </a>
              <a href="https://www.linkedin.com/in/mdrezaulkarim4119" target="_blank" rel="noreferrer" className="social-btn linkedin">
              ...
              <a href="https://x.com/Mdrejaul178869" target="_blank" rel="noreferrer" className="social-btn twitter">
              ...
              <a href="https://www.facebook.com/share/1CDmmU7CFR" target="_blank" rel="noreferrer" className="social-btn facebook">
            ...
            <div className="cta-minimal">
                ...
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=mdrezaulkarim4119@gmail.com" target="_blank" rel="noreferrer" className="email-link">
                  mdrezaulkarim4119@gmail.com
                </a>
            </div>
          </motion.div>
        </motion.div>
